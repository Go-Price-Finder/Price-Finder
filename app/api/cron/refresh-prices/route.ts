      ...
      console.log(
        "[refresh-prices] " +
          JSON.stringify({
            ...
            feedRows: p.feedRows,
            matched: p.matched,
            matchedByGtin: p.matchedByGtin,
            gtinCollisionsInFeed: p.gtinCollisionsInFeed,
            gtinCollisionsInCatalog: p.gtinCollisionsInCatalog,
            gtinKeysUsable: p.gtinKeysUsable,
            compared: p.compared,
