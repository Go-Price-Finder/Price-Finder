...
export async function generateMetadata({
  ...
  return {
    title: `${product.name} — Brooklyn Delhi — Price Finder`,
    description: product.description.slice(0, 155),
  };
}

export default async function BrooklynDelhiProductPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* Breadcrumb — Home / Brooklyn Delhi / Product Name */}
        <div className="mx-auto max-w-7xl px-5 pt-6 sm:px-8">
          <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-1.5 text-xs text-ivory-400">
            ...
            <Link href="/brooklyn-delhi" className="transition-colors hover:text-gilt-400">
              Brooklyn Delhi
            </Link>
            <ChevronRightIcon className="h-3 w-3" />
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs text-ivory-400">
                &ldquo;View on Brooklyn Delhi&rdquo; takes you to Brooklyn Delhi&rsquo;s own store to complete your purchase.
              </p>
