...
import { GOLDEN_MAPLE_CATEGORIES } from "@/lib/golden-maple-data";
      ...
      <main className="flex-1">
        ...
        <div className="mx-auto max-w-7xl px-5 pb-2 pt-6 sm:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-sm leading-relaxed text-ivory-300 sm:text-base">
              ...
              Golden Maple — {products.length} products, organized by
              category. Every price and link below goes straight to Golden
              Maple&rsquo;s own store.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8">
          <div className="flex flex-col gap-14">
            {GOLDEN_MAPLE_CATEGORIES.map((category) => {
