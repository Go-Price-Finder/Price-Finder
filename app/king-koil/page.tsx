      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-5 pt-6 sm:px-8">
          <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-1.5 text-xs text-ivory-400">
            ...
            <span className="text-ivory-200">King Koil</span>
          </nav>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 pb-2 pt-6 sm:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-sm leading-relaxed text-ivory-300 sm:text-base">
              Air mattresses and inflatable bedding from King Koil —{" "}
              {products.length} products. Every price and link below goes
              straight to King Koil&rsquo;s own store.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8">
          <div className="flex flex-col gap-14">
            {KING_KOIL_CATEGORIES.map((category) => {
